...
BOOL COSdesignApp::InitInstance()
{
	...
	memset(m_state->available,0,sizeof(m_state->available));
	memset(m_state->max,0,sizeof(m_state->max));
	memset(m_state->need,0,sizeof(m_state->need));
	memset(m_state->request,0,sizeof(m_state->request));
	memset(m_state->resource,0,sizeof(m_state->resource));
